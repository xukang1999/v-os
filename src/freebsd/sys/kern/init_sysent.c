...
struct sysent sysent[] = {
	...
	{.sy_narg = AS(__mac_get_proc_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 384 = __mac_get_proc */
	{.sy_narg = AS(__mac_set_proc_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 385 = __mac_set_proc */
	{.sy_narg = AS(__mac_get_fd_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 386 = __mac_get_fd */
	{.sy_narg = AS(__mac_get_file_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 387 = __mac_get_file */
	{.sy_narg = AS(__mac_set_fd_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 388 = __mac_set_fd */
	{.sy_narg = AS(__mac_set_file_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 389 = __mac_set_file */
	...
	{.sy_narg = AS(mac_syscall_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 394 = mac_syscall */
	...
	{.sy_narg = AS(__mac_get_pid_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 409 = __mac_get_pid */
	{.sy_narg = AS(__mac_get_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 410 = __mac_get_link */
	{.sy_narg = AS(__mac_set_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 411 = __mac_set_link */
	{.sy_narg = AS(extattr_set_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_EXTATTR_SET_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 412 = extattr_set_link */
	{.sy_narg = AS(extattr_get_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_EXTATTR_GET_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 413 = extattr_get_link */
	{.sy_narg = AS(extattr_delete_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_EXTATTR_DELETE_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 414 = extattr_delete_link */
	{.sy_narg = AS(__mac_execve_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 415 = __mac_execve */
	...
	{.sy_narg = AS(__acl_get_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_ACL_GET_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 425 = __acl_get_link */
	{.sy_narg = AS(__acl_set_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_ACL_SET_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 426 = __acl_set_link */
	{.sy_narg = AS(__acl_delete_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_ACL_DELETE_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 427 = __acl_delete_link */
	{.sy_narg = AS(__acl_aclcheck_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_ACL_CHECK_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 428 = __acl_aclcheck_link */
	...
	{.sy_narg = AS(extattr_list_fd_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_EXTATTR_LIST_FD, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 437 = extattr_list_fd */
	{.sy_narg = AS(extattr_list_file_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_EXTATTR_LIST_FILE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 438 = extattr_list_file */
	{.sy_narg = AS(extattr_list_link_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_EXTATTR_LIST_LINK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 439 = extattr_list_link */
	...
	{.sy_narg = AS(audit_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_AUDIT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 445 = audit */
	{.sy_narg = AS(auditon_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_AUDITON, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 446 = auditon */
	{.sy_narg = AS(getauid_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_GETAUID, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 447 = getauid */
	{.sy_narg = AS(setauid_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_SETAUID, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 448 = setauid */
	{.sy_narg = AS(getaudit_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_GETAUDIT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 449 = getaudit */
	{.sy_narg = AS(setaudit_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_SETAUDIT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 450 = setaudit */
	{.sy_narg = AS(getaudit_addr_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_GETAUDIT_ADDR, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 451 = getaudit_addr */
	{.sy_narg = AS(setaudit_addr_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_SETAUDIT_ADDR, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 452 = setaudit_addr */
	{.sy_narg = AS(auditctl_args), .sy_call = (sy_call_t*)nosys, .sy_auevent = AUE_AUDITCTL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 453 = auditctl */
