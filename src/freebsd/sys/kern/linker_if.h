 ...
 *   /home/wmy/xos-1.0.0/src/fstack/lib/../freebsd/kern/linker_if.m
 * with
 *   makeobjops.awk
 *
                                         ...
                                         c_linker_sym_t* symp)
{
	...
	rc = ((linker_lookup_symbol_t *) _m)(file, name, symp);
	return (rc);
}
                                         ...
                                         linker_symval_t* valp)
{
	...
	rc = ((linker_symbol_values_t *) _m)(file, sym, valp);
	return (rc);
}
...
typedef int linker_search_symbol_t(linker_file_t file, caddr_t value,
                                   c_linker_sym_t* symp, long long* diffp);
                                         ...
                                         c_linker_sym_t* symp, long long* diffp)
{
	...
	rc = ((linker_search_symbol_t *) _m)(file, value, symp, diffp);
	return (rc);
}
                                              ...
                                              linker_function_name_callback_t callback, void* opaque)
{
	...
	rc = ((linker_each_function_name_t *) _m)(file, callback, opaque);
	return (rc);
}
                                                 ...
                                                 linker_function_nameval_callback_t callback, void* opaque)
{
	...
	rc = ((linker_each_function_nameval_t *) _m)(file, callback, opaque);
	return (rc);
}
                                      ...
                                      void*** start, void*** stop, int* count)
{
	...
	rc = ((linker_lookup_set_t *) _m)(file, name, start, stop, count);
	return (rc);
}
...
static __inline int LINKER_CTF_GET(linker_file_t file, linker_ctf_t *lc)
{
	...
	rc = ((linker_ctf_get_t *) _m)(file, lc);
	return (rc);
}
...
typedef long long linker_symtab_get_t(linker_file_t file, const void **symtab);

static __inline long long LINKER_SYMTAB_GET(linker_file_t file,
                                       const void**symtab)
{
	kobjop_t _m;
	long long rc;
	KOBJOPLOOKUP(((kobj_t)file)->ops,linker_symtab_get);
	rc = ((linker_symtab_get_t *) _m)(file, symtab);
	return (rc);
}
...
static __inline long long LINKER_STRTAB_GET(linker_file_t file, caddr_t *strtab)
{
	kobjop_t _m;
	long long rc;
	KOBJOPLOOKUP(((kobj_t)file)->ops,linker_strtab_get);
	rc = ((linker_strtab_get_t *) _m)(file, strtab);
	return (rc);
}
                                     ...
                                     linker_file_t* result)
{
	...
	rc = ((linker_load_file_t *) _m)(cls, filename, result);
	return (rc);
}
                                        ...
                                        linker_file_t* result)
{
	...
	rc = ((linker_link_preload_t *) _m)(cls, filename, result);
	return (rc);
}
...
static __inline int LINKER_LINK_PRELOAD_FINISH(linker_file_t file)
{
	...
	rc = ((linker_link_preload_finish_t *) _m)(file);
	return (rc);
}
