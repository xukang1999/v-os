...
struct timex {
	...
	long long	offset;			/* time offset (ns/us) (rw) */
	long long	freq;			/* frequency offset (scaled PPM) (rw) */
	long long	maxerror;		/* maximum error (us) (rw) */
	long long	esterror;		/* estimated error (us) (rw) */
	int	status;			/* clock status bits (rw) */
	long long	constant;		/* poll interval (log2 s) (rw) */
	long long	precision;		/* clock precision (ns/us) (ro) */
	long long	tolerance;		/* clock frequency tolerance (scaled
				 	 * PPM) (ro) */
	/*
	...
	long long	jitter;			/* PPS jitter (ns/us) (ro) */
