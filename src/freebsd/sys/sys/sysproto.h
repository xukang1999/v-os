...
struct fcntl_args {
	...
	char arg_l_[PADL_(long long)]; long arg; char arg_r_[PADR_(long long)];
};
struct select_args {
...
struct msgrcv_args {
	...
	char msgsz_l_[PADL_(size_t)]; size_t msgsz; char msgsz_r_[PADR_(size_t)];
	char msgtyp_l_[PADL_(long long)]; long msgtyp; char msgtyp_r_[PADR_(long long)];
	char msgflg_l_[PADL_(int)]; int msgflg; char msgflg_r_[PADR_(int)];
};
struct shmat_args {
...
struct afs3_syscall_args {
	char syscall_l_[PADL_(long long)]; long long syscall; char syscall_r_[PADR_(long long)];
	char parm1_l_[PADL_(long long)]; long long parm1; char parm1_r_[PADR_(long long)];
	char parm2_l_[PADL_(long long)]; long long parm2; char parm2_r_[PADR_(long long)];
	char parm3_l_[PADL_(long long)]; long long parm3; char parm3_r_[PADR_(long long)];
	char parm4_l_[PADL_(long long)]; long long parm4; char parm4_r_[PADR_(long long)];
	char parm5_l_[PADL_(long long)]; long long parm5; char parm5_r_[PADR_(long long)];
	char parm6_l_[PADL_(long long)]; long long parm6; char parm6_r_[PADR_(long long)];
};
struct nmount_args {
	char iovp_l_[PADL_(struct iovec*)]; struct iovec* iovp; char iovp_r_[PADR_(struct iovec*)];
...
struct thr_create_args {
	...
	char id_l_[PADL_(long long*)]; long long* id; char id_r_[PADR_(long long*)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct thr_exit_args {
	char state_l_[PADL_(long long*)]; long long* state; char state_r_[PADR_(long long*)];
};
...
struct getfsstat_args {
	char buf_l_[PADL_(struct statfs*)]; struct statfs* buf; char buf_r_[PADR_(struct statfs*)];
	char bufsize_l_[PADL_(long long)]; long long bufsize; char bufsize_r_[PADR_(long long)];
	char mode_l_[PADL_(int)]; int mode; char mode_r_[PADR_(int)];
};
